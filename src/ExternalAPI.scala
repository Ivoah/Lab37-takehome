...
case class APIResponse(response: Int, data: Option[Map[String, APIOrder]], error: Option[String]) derives Format
...
// {"order": 4645, "name": "Grilled cheese with tomato soup", "category": "Lunch & Dinner", "price": 12.74, "status": "ordered"}
